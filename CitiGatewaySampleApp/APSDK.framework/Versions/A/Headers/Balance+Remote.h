...
/*!
 @header Balance+Remote
 @abstract Remote category for Balance class
 */

#import "Balance.h"

/*!
 @category Balance (Remote)
 @abstract Adds remote CRUD capabilities to Balance.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface Balance (Remote)
