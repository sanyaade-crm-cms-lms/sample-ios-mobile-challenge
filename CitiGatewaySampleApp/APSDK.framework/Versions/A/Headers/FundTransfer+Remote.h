//
//  FundTransfer+Remote.h
//  AnyPresence SDK
//

/*!
 @header FundTransfer+Remote
 @abstract Remote category for FundTransfer class
 */

#import "FundTransfer.h"

/*!
 @category FundTransfer (Remote)
 @abstract Adds remote CRUD capabilities to FundTransfer.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface FundTransfer (Remote)
