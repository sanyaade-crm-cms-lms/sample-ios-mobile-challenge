...
/*!
 @header Account+Remote
 @abstract Remote category for Account class
 */

#import "Account.h"

/*!
 @category Account (Remote)
 @abstract Adds remote CRUD capabilities to Account.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface Account (Remote)
