//
//  Transaction+Remote.h
//  AnyPresence SDK
//

/*!
 @header Transaction+Remote
 @abstract Remote category for Transaction class
 */

#import "Transaction.h"

/*!
 @category Transaction (Remote)
 @abstract Adds remote CRUD capabilities to Transaction.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface Transaction (Remote)
