...
/*!
 @header LoginInfo+Remote
 @abstract Remote category for LoginInfo class
 */

#import "LoginInfo.h"

/*!
 @category LoginInfo (Remote)
 @abstract Adds remote CRUD capabilities to LoginInfo.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface LoginInfo (Remote)
